...
fn main() {
    ...
    println!(
        "99% tail latency: {:.0} us",
        total_histo.value_at_percentile(99.0)
    );
    println!(
        "99.9% tail latency: {:.0} us",
        total_histo.value_at_percentile(99.9)
    );
    println!(
        "99.99% tail latency: {:.0} us",
        total_histo.value_at_percentile(99.99)
    );
